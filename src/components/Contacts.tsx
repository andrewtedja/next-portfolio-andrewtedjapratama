    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[90vh] bg-[#FCFCFC] py-16"> 
            ...
            <div className="flex space-x-8">
                <a href="https://github.com/Fozzzzy" className="text-blue-500 transition-transform hover:scale-125">
                ...
                <a href="https://www.linkedin.com/in/andrewtedjapratama" className="text-blue-500 transition-transform hover:scale-125">
                ...
                <a href="https://www.instagram.com/andrewtedj/" className="text-blue-500 transition-transform hover:scale-125">
                    <svg className="w-[40px] h-[40px]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
